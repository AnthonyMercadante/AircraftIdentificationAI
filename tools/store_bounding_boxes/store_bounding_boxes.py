...
store_bounding_boxes('../../runs/detect/train4/weights/best.pt', '../../dataset/unseen_images/Classifications/Multi Engine', 'bounding_boxes.csv', 'output_images', 'test-config.yaml')
