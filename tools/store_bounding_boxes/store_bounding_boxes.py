...
store_bounding_boxes('../../runs/detect/train4/weights/best.pt', '../../dataset/unseen_images/hawker_hurricane (grayscale)', 'bounding_boxes.csv', 'output_images', 'test-config.yaml')
